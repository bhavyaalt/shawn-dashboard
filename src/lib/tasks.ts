...
export const tasks: Task[] = [
  ...
  {
    id: 'SHAWN-011',
    title: 'Study Base Paymaster & Gas Sponsorship',
    description: 'Learn how to sponsor gas fees for users on Base',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
  ...
  {
    id: 'SHAWN-012',
    title: 'Deep dive into Foundry testing',
    description: 'Fuzz testing, invariant testing, fork testing patterns',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
    createdAt: '2026-01-30T09:10:00Z',
  ...
  {
    id: 'SHAWN-013',
    title: 'Study ERC-4337 Account Abstraction',
    description: 'Smart accounts, bundlers, paymasters for better UX',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
    createdAt: '2026-01-30T09:10:00Z',
  ...
  {
    id: 'SHAWN-014',
    title: 'Study OnchainKit Components',
    description: 'Deep dive into all available components: Identity, Wallet, Transaction, Swap, etc.',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
  ...
  {
    id: 'SHAWN-015',
    title: 'Study OpenZeppelin Access Control',
    description: 'Ownable, Ownable2Step, AccessControl, TimelockController patterns',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
  ...
  {
    id: 'SHAWN-016',
    title: 'Study Upgradeable Contract Patterns',
    description: 'ERC-7201 namespaced storage, initializers, proxy patterns',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
    createdAt: '2026-01-30T09:20:00Z',
  ...
  {
    id: 'SHAWN-017',
    title: 'Study DeFi/Lending Patterns',
    description: 'Pool patterns, collateral management, period/round mechanics for ROSCA',
    status: 'completed',
    priority: 'medium',
    project: 'Learning',
    createdAt: '2026-01-30T09:20:00Z',
